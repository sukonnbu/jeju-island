    ...
    return (
      ...
      <div>
        ...
        <details>
          ...
          <p>
          제주 흑돼지의 기원은 2세기~5세기 경 야생 멧돼지를 잡아 키운 것이 기원이며
          현재 대한민국 천연기념물 제550호로 지정되어 있다.
          <br />
        ...
        <details>
          ...
          <p>
            ...
            <br />
            현재 제주도에는 40~50곳의 말고기 음식점이 있으며 이마트에서도 말고기를 구할 수 있다고 한다.
            <br />
            제주 중문에 있는 한 말고기 음식점은 미슐랭 가이드에도 소개된 적이 있다고 한다.
            <br />
            말고기는 육회, 찜, 구이 등 다양한 형태로 먹을 수 있으며
            대체적으로 소고기로 만드는 모든 요리가 말고기로도 가능하다고 한다.
            <br />
          </p>
        </details>
        ...
        <details>
          ...
          <br />
          이 당시 감귤 농사가 풍년을 이루어 감귤 가격 폭락을 막기 위해 제주도에서 감귤 농축액 공장을 설립하였고,
          이곳에 초콜릿을 만드는 민간기업을 유치하였다.
          <br />
          그 결과로 감귤초콜릿이 처음 만들어졌으며 현재는 다양한 회사에서 감귤뿐 아니라 한라봉, 녹차, 백년초 등
          다양한 제주도 특산물을 활용하여 초콜릿을 만들고 있다.
          <br />
          </p>
