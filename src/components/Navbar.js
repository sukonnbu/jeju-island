  ...
  return (
    <header className="App-header font-NanumSquare">
      <nav className="m-3 place-content-center border-4 h-32 bg-jeju-banner bg-cover">
        <div className="m-3">
          <Link to="/" className="grid grid-cols-2 justify-between">
            <h1 className="text-4xl text-center text-emerald-900 justify-self-end">소규모테마형</h1>
            <h1 className="text-4xl text-center text-emerald-500 justify-self-start">교육여행</h1>
            </Link>
        </div>
        <div className="p-1 place-content-center">
          <ul className="grid grid-cols-5 justify-items-center items-center text-center text-white">
